...
import android.os.Bundle; import android.widget.Toast; import androidx.appcompat.app.AppCompatActivity; import androidx.recyclerview.widget.RecyclerView;
...
public class Task15Activity extends AppCompatActivity {
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        rv.setAdapter(new StateRVAdapterClick(list, (s, pos) -> Toast.makeText(this, "Клик: " + s.getName(), Toast.LENGTH_SHORT).show()));
    }
}